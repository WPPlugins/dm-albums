...
$flikr = dm_sanitize_var($_GET["flikr"]);
...
Galleria.loadTheme('<?php echo plugins_url(); ?>/dm-albums/galleria/themes/classic/galleria.classic.js');

//$('#galleria-<?php echo $albumid; ?>').galleria({
Galleria.run('#galleria-<?php echo $albumid; ?>', {
<?
if($flikr != -1)
{
	?>
	flickr: 'set:<?php echo $flikr; ?>',
    flickrOptions: {
        sort: 'date-taken-asc',
    	max: 100
    },
